      ...
      <el-card>
        <div class="batch-content">
          ...
          <div class="batch-buttons">
            <el-button @click="pauseSelectedTasks" :disabled="!hasDownloadingSelected">
              暂停选中
            </el-button>
            <el-button @click="resumeSelectedTasks" :disabled="!hasPausedSelected">
              继续选中
            </el-button>
            <el-button @click="deleteSelectedTasks" type="danger">
              删除选中
            </el-button>
...
const selectedTasks = ref<string[]>([])  // 选中的任务ID
...
const filteredTasks = computed(() => {
  ...
  if (searchKeyword.value) {
    ...
    filtered = filtered.filter(task => 
      ...
      (task.uploader && task.uploader.toLowerCase().includes(keyword))
    )
  }
